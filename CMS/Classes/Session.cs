...
namespace CMS.Classes
{
    internal class Session
    {
        ...
        // SESSION CONSTRUCTOR
        public Session(int conferenceID, string conferenceName, int sessionID, string sessionTitle, string sessionDescription, DateTime conferenceDate, string speaker, string venue)
        {
        ...
        public void CreateSession(int conferenceID, string conferenceName, int sessionID, string sessionTitle, string sessionDescription, DateTime conferenceDate, string speaker, string venue)
        {
